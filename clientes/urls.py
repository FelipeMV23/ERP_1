...
from clientes.views import crear_cliente, consultar_clientes, editar_cliente, eliminar_cliente
...
urlpatterns = [
    ...
    path('eliminar/<int:cod_cliente>/', eliminar_cliente, name='eliminar_cliente'),
]