...
from pedidos.views import crear_pedido, añadir_abono, listar_pedidos, listar_pedidos_filtrados, eliminar_pedido
...
urlpatterns = [
    ...
    path('eliminar_pedido/<int:cod_pedido>/', eliminar_pedido, name='eliminar_pedido'),
